...
func (x *GetInformationRequest) GetInn() string {
	if x != nil {
		return x.Inn
	}
	return ""
...
func (x *GetInformationResponse) GetInn() string {
	if x != nil {
		return x.Inn
	}
	return ""
...
func (x *GetInformationResponse) GetKpp() string {
	if x != nil {
		return x.Kpp
	}
	return ""
...
func (x *GetInformationResponse) GetFio() string {
	if x != nil {
		return x.Fio
	}
	return ""
...
func (x *GetInformationResponse) GetCompany() string {
	if x != nil {
		return x.Company
	}
	return ""
...
var file_proto_search_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x29, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x49, 0x6e,
	...
	0x6e, 0x6e, 0x22, 0x68, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61,
	...
	,
...
var file_proto_search_proto_goTypes = []interface{}{
	(*GetInformationRequest)(nil),  // 0: api.GetInformationRequest
	(*GetInformationResponse)(nil), // 1: api.GetInformationResponse
}
var file_proto_search_proto_depIdxs = []int32{
	0, // 0: api.GetInformation.Add:input_type -> api.GetInformationRequest
	1, // 1: api.GetInformation.Add:output_type -> api.GetInformationResponse
...
type GetInformationClient interface {
	Add(ctx context.Context, in *GetInformationRequest, opts ...grpc.CallOption) (*GetInformationResponse, error)
}
...
func (c *getInformationClient) Add(ctx context.Context, in *GetInformationRequest, opts ...grpc.CallOption) (*GetInformationResponse, error) {
	out := new(GetInformationResponse)
	err := c.cc.Invoke(ctx, "/api.GetInformation/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GetInformationServer interface {
	Add(context.Context, *GetInformationRequest) (*GetInformationResponse, error)
}

// UnimplementedGetInformationServer can be embedded to have forward compatible implementations.
type UnimplementedGetInformationServer struct {
}

func (*UnimplementedGetInformationServer) Add(context.Context, *GetInformationRequest) (*GetInformationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}

func RegisterGetInformationServer(s *grpc.Server, srv GetInformationServer) {
	s.RegisterService(&_GetInformation_serviceDesc, srv)
}

func _GetInformation_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetInformationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GetInformationServer).Add(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.GetInformation/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GetInformationServer).Add(ctx, req.(*GetInformationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _GetInformation_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.GetInformation",
	HandlerType: (*GetInformationServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Add",
			Handler:    _GetInformation_Add_Handler,
		},
	},
